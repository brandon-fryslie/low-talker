...
public enum AudioHardwareError: Error, Equatable, CustomStringConvertible {
    ...
    public var description: String {
        ...
        case .preparingOpenedTheDevice(let device): "readying a microphone opened device \(device) instead of only reaching it, so the microphone was given back rather than held open with nobody dictating"
