...
struct LowTalker: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        subcommands: [Info.self, ConfigCommand.self, DriverCommand.self, OnboardCommand.self, SeeCommand.self, ClickCommand.self, RouteCommand.self, ActCommand.self, TypeCommand.self, KeysCommand.self, MicCommand.self, RecordCommand.self, TranscribeCommand.self, ModelCommand.self, HotkeyCommand.self, PasteCommand.self, BenchCommand.self, DextCommand.self, DictateCommand.self]
    )
}
