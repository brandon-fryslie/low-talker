...
public struct LowTalker: AsyncParsableCommand {
    public static let configuration = CommandConfiguration(
        ...
        subcommands: [Info.self, ConfigCommand.self, GrantsCommand.self, DriverCommand.self, OnboardCommand.self, SeeCommand.self, ClickCommand.self, PointerCommand.self, RouteCommand.self, ActCommand.self, TypeCommand.self, KeysCommand.self, MicCommand.self, RecordCommand.self, TranscribeCommand.self, ModelCommand.self, HotkeyCommand.self, PasteCommand.self, BenchCommand.self, DextCommand.self, DictateCommand.self]
    )
