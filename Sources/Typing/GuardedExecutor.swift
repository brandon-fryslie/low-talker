...
extension Executor {
    ...
    public static func guarding(
        ...
        return Executor(
            keyboard: { GuardedKeyboard(keyboard: keyboard, queue: queue, interrupt: interrupt, screen: TargetApp(bundleID: $0, interrupt: interrupt)) },
            mouse: {
                ...
                return Pointer(
                    mouse: GuardedMouse(pointing: mouse, queue: queue, interrupt: interrupt, screen: target),
