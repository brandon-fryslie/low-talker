...
- `registered, switched off` is where a first install waits for the next login. The step says to log out and back in. If it still reads this after that, choose the delivery again.
